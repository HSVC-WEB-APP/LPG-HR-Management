...
> **★ v9.6 — bốn nhóm, một chỗ khai.** Tổ chỉ còn bốn nhóm ca **A · B · C · D**
> và khối **Office**; "DCS" và "Field" nay chỉ là VỊ TRÍ, không còn là nhóm.
> Ca chuẩn khai ở đúng một màn (mỗi nhóm một kiểu ca + một mốc), linh hoạt
> từng người khai bằng **Áp pattern** ở ca thực tế. Màn *Tái cơ cấu* và bảng
> *dải chặng* đã bỏ hẳn. Chi tiết: `_docs-v96.md`.
...
│   ├── 23-course.js        # v7.8: Khoá đào tạo (S.courses) — nạp sau 22-training.js
│   ├── 25-vessel.js        # v8.9: Lịch tàu nhiều phương án
│   ├── 28-stdshift.js      # v9.6: Ca chuẩn khai theo NHÓM + khai nghỉ việc
│   ├── 27-pattern.js       # v9.5: Áp PATTERN vào ca THỰC TẾ — nạp sau 28-stdshift.js
│   ├── 21-notify.js        # Hàng đợi + khuôn tin Zalo (tên file cố ý không có chữ "zalo")
│   └── 12-main.js          # Boot — luôn nạp CUỐI CÙNG
├── _docs-v90.md … _docs-v96.md  # Ghi chép từng bản: vì sao đổi, đổi gì, bẫy đã gặp
├── _test/                  # Harness Node (vm) — `node _test/<tên>.js` từ thư mục này
