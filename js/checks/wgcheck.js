...
function _pttShowOverlay(d){
  ...
  /* v4.143 - tooltip cho biet density lay tu dau (lot nao / bang nhiet do /
     go tay). Chi them thuoc tinh title nen KHONG doi bo cuc phieu in. */
  const sfTip = d.sfNote ? ' title="'+e(d.sfNote)+'"' : '';
  h+='<div class="pf-il" style="font-size:8pt;padding:2px 4px">Safe Fill Allow</div><div class="pf-iv" style="font-family:\'Courier New\',monospace;padding:2px 5px;display:flex;align-items:center"><span contenteditable="true" id="pttov-sf"'+sfTip+' style="font-size:20pt;font-weight:900;font-family:\'Courier New\',monospace">'+e(sfStr)+'</span><span style="font-size:9pt;color:#666;margin-left:4px;font-weight:600">kg</span></div>';
